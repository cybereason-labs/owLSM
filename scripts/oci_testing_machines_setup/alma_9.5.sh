...
# AlmaLinux 9.5 Complete Setup Script
# Run as root

set -e  # Exit on error

echo "=========================================="
echo "Starting AlmaLinux 9.5 System Setup"
echo "=========================================="
...
# Add admin to wheel group (sudo equivalent in RHEL/AlmaLinux)
...
# Check if Python 3.12 is available in repos
...
# Use Python 3.9 interpreter for cloud-init
echo "Setting cloud-init to use Python 3.9..."
sed -i '1s|#!/usr/bin/python3|#!/usr/bin/python3.9|' /usr/bin/cloud-init
